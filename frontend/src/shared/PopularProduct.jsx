    ...
    return (
        <div className="mt-10 mr-10 ml-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                {/* Cards 2-7 */}
                {[...Array(7)].map((_, index) => (
                    <NavLink key={index} to="/detail">
                        <div className="bg-nt09 rounded-6xl p-6 flex items-center justify-between flex-col m-4 cursor-pointer">
                            <img src={imagePopularProduct} alt="product" />
